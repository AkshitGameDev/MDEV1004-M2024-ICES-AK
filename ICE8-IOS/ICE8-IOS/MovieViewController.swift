...
class MovieViewController: UIViewController, UITableViewDelegate, UITableViewDataSource
{
    ...
    func fetchMovies(completion: @escaping ([Movie]?, Error?) -> Void)
    {
        ...
        guard let url = URL(string: "https://mdev1004-ices-api-8zdc.onrender.com/api/movie/list") else
    ...
    func deleteMovie(at indexPath: IndexPath)
    {
        ...
        guard let url = URL(string: "https://mdev1004-ices-api-8zdc.onrender.com/api/movie/delete/\(movie._id)") else {
            print("Invalid URL")
            return
        }
