...
public final class TextRowItemBinding implements ViewBinding {
  ...
  private TextRowItemBinding(@NonNull LinearLayout rootView, @NonNull TextView rating,
      @NonNull TextView studio, @NonNull TextView title) {
  ...
  public static TextRowItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new TextRowItemBinding((LinearLayout) rootView, rating, studio, title);
    }
